...
# Function to find a gate with specific wires and gate type
...
# Function to swap the output wires in the configurations
...
# Function to check for parallel adders and generate the required swaps
